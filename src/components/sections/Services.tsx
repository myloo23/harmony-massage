...
import servicesImg800 from "../../assets/optimized/services-800.jpg";
import servicesImg1400 from "../../assets/optimized/services-1400.jpg";
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div className="rounded-3xl overflow-hidden shadow-xl aspect-4/3">
            <img
              src={servicesImg1400}
              srcSet={`${servicesImg800} 800w, ${servicesImg1400} 1400w`}
